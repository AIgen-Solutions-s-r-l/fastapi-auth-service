...
async def test_no_double_email_sending():
    """Test that emails are not double-sent for one-time payments."""
    logger.info("Starting test to verify no double email sending")
...
if __name__ == "__main__":
    asyncio.run(test_no_double_email_sending())