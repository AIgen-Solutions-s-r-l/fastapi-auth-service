...
from app.services.user_service import verify_reset_token, reset_password
...
async def test_reset_password_success(client, monkeypatch, db_session):
    ...
    # Mock send_password_reset_confirmation
    async def mock_send_email(*args, **kwargs):
        return True
    ...
    monkeypatch.setattr(
        "app.services.email_service.EmailService.send_password_reset_confirmation", 
        mock_send_email
    )
